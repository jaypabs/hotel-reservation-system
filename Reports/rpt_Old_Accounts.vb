...
Public Class rpt_Old_Accounts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rpt_Old_Accounts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Old_Accounts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Old_Accounts = New rpt_Old_Accounts
        rpt.Site = Me.Site
        Return rpt
    End Function
