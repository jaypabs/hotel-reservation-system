...
Public Class rpt_Guest_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rpt_Guest_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Guest_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Guest_List = New rpt_Guest_List
        rpt.Site = Me.Site
        Return rpt
    End Function
