...
Public Class rpt_Reservation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rpt_Reservation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Reservation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Reservation = New rpt_Reservation
        rpt.Site = Me.Site
        Return rpt
    End Function
